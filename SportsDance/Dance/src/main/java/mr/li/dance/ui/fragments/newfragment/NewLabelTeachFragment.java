...
import mr.li.dance.ui.fragments.adapter.NewLabelTeachAdapter;
 ...
 * 修订历史:
 */
public class NewLabelTeachFragment extends BaseListFragment {
    int page = 1;
    NewLabelTeachAdapter adapter;
    String               path;
    ...
    public void initData() {
        ...
        Log.d(tag, path);
        Request<String> homeTabhMap = ParameterUtils.getSingleton().getHomeTabhMap(path, "10903", String.valueOf(page));
    ...
    public RecyclerView.Adapter getAdapter() {
        adapter = new NewLabelTeachAdapter(getActivity());
    ...
    @Override
    public void itemClick(int position, Object ziXunInfo) {
        TeachInfo item = (TeachInfo) ziXunInfo;
