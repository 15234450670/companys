...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = DanceApplication.instances.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = DanceApplication.instances.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
