...
import mr.li.dance.ui.fragments.adapter.NewLabelMusicAdapter;
 ...
 * 修订历史:
 */
public class NewLabelMusicFragment  extends BaseListFragment<TeachInfo> {
    int page = 1;
    NewLabelMusicAdapter adapter;
    String               path;
    ...
    public void initData() {
        ...
        Log.d(tag,path);
        Request<String> homeTabhMap = ParameterUtils.getSingleton().getHomeTabhMap(path,"10904", String.valueOf(page));
    ...
    public RecyclerView.Adapter getAdapter() {
        adapter = new NewLabelMusicAdapter(getActivity());
    ...
    public void itemClick(int position, TeachInfo ziXunInfo) {
        SongActivity.lunch(getActivity(),ziXunInfo.getId(),ziXunInfo.getTitle());
    }
}
